  ...
  <div class="row">
      <div class="col s12 m12 l12">
        <ul class="collapsible" data-collapsible="expandable">
          <li>
     <div class="collapsible-header active"><i class="material-icons">games</i>Snooker</div>
     <div class="collapsible-body" id="login_inside">

       <div class="row" style="text-align:center">
				 <iframe src="snooker/index.html" style="border:0;width:80%;height:800px"></iframe>
       </div>
